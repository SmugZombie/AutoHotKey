...
Menu, Context, add
Menu, Context, add, FlushDNS, FlushDNS
Menu, Context, add
...
Menu, tray, add, FlushDNS, FlushDNS
...
Restore:
FileSelectFile, SelectedFile, 3, , Restore HOST from .bak, .bak Documents (*.bak)
if(SelectedFile != ""){
filedelete, %hostsdir%
LV_Delete()
Loop, read, %SelectedFile%, %hostsdir%
	{
	Loop, parse, A_LoopReadLine, `n
	{
		if A_LoopField <>
...
msgbox, All changes since last edit have been removed. Remember to Save.
Saved=0
}
else{
	Msgbox Please Try Again with a Valid File
}
return
...
#IfWinActive Hostfile Editor 0.05 ahk_class AutoHotkeyGUI
Delete::
gosub, Delete
return
