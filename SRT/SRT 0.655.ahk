...
;##			To Do:
;##				- Automatic Updates
;##		0.653- Automatically removes "ftp://" from ftp input into host
;##		0.654- Automatically accepts FTP:// calls		
;##					Automatically Launches with FTP URL
;##		0.655- Corrected / added new chars
;##
;################################################
#NoEnv
SendMode Input
...
ConnectionTypes3 = SSH|RDP|FTP||SFTP|%ifVNC%
...
GuiHide = 0
ClipHost = %clipboard%
StringLeft, protocol, ClipHost, 6
if(protocol = "ftp://"){
	StringReplace, ClipHost, ClipHost, `%40, `@, All
	StringReplace, ClipHost, ClipHost, `%24, `$, All
	StringReplace, ClipHost, ClipHost, `%24, `^, All
	StringReplace, ClipHost, ClipHost, `%5E, `!, All

	StringReplace, ClipHost, ClipHost, `%2B, `+, All
	StringReplace, ClipHost, ClipHost, `%5E, `^, All
	StringReplace, ClipHost, ClipHost, `%21, `!, All
	StringReplace, ClipHost, ClipHost, `%40, `@, All
	StringReplace, ClipHost, ClipHost, `%23, `#, All

	StringReplace, ClipHost, ClipHost, `%24, `$, All
	StringReplace, ClipHost, ClipHost, `%25, `%, All
	StringReplace, ClipHost, ClipHost, `%26, `&, All
	StringReplace, ClipHost, ClipHost, `%2A, `*, All
	StringReplace, ClipHost, ClipHost, `%28, `(, All

	StringReplace, ClipHost, ClipHost, `%29, `), All
	StringReplace, ClipHost, ClipHost, `%7C, `|, All
	StringReplace, ClipHost, ClipHost, `%5C, `\, All
	StringReplace, ClipHost, ClipHost, `%2F, `/, All
	StringReplace, ClipHost, ClipHost, `%3F, `?, All

	StringReplace, ClipHost, ClipHost, `%3D, `=, All
	StringReplace, ClipHost, ClipHost, `%58, `[, All
	StringReplace, ClipHost, ClipHost, `%5D, `], All
	StringReplace, ClipHost, ClipHost, `%7B, `{, All
	StringReplace, ClipHost, ClipHost, `%7D, `}, All

	StringReplace, ClipHost, ClipHost, `%7E, `~, All
	GuiControl,, Types, |%ConnectionTypes3%
...
StringReplace, host, host, ftp:// ,, All
