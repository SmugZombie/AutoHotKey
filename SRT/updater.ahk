Check_ForUpdate(_ReplaceCurrentScript = 1, _SuppressMsgBox = 0, _CallbackFunction = "", ByRef _Information = "", _version = 0.01)
{
	Global
	...
	Static Script_Name := "SRTAware" ;Your script name
	, Version_Number := version ;The script's version number
	, Update_URL := "http://srt.egli.me/downloads/version.ini" ;The URL of the version.ini file for your script
