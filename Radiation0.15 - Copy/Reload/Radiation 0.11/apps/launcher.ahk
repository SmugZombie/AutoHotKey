...
Gui, Add, ListBox, vMyListBox gMyListBox w350 r13
Gui, Add, Button, Default, Launch
Gui, Add, Button, ym+198 x+5, Add
...
{
	If(InStr(A_LoopFileFullPath,"launcher.ahk"))
	{
	}
	else
	{
...
Gui, Show, ,Radiation Launcher (esc to close)
return
