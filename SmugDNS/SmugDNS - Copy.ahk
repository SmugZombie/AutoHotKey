...
Gui, Add, Edit, x552 y43 w164 h20 vwhohostsit readonly,
...
Gui, Font, cBlue
Gui, Add, Text, x20 y425 glink vlink, Open in Browser
Gui, Add, Text, x20 y440 gTZlink vTZlink, Open in ToolZilla
Gui, Add, Text, x20 y455 gREGlink vREGlink, Open in Reggie
Gui, Add, Text, x20 y470 gDZAlink vDZAlink, Open in DZA
Gui, Add, Text, x20 y485 gElink vElink, Open in Email Tool
Gui, Add, GroupBox, x125 y420 w2 h80,
Gui, Add, Text, x130 y425 gtrace vtrace, Trace Path (local)
Gui, Font, cGray
Gui, Add, Text, x130 y440, Trace Path (external)
Gui, Font, cBlue
Gui, Add, Text, x130 y455 gping vping, Ping Address
Gui, Add, Text, x130 y470 gIPWho, IP Whois
Gui, Font, cGray
