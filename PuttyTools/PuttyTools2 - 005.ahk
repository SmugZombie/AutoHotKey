...
Enabled = disabled
gosub, ReadINI
Defaults = export HISTFILE=~/.support_history; echo "%UserName% - Professional Hosting Services"||history|su -|grep MemTotal /proc/meminfo|free -m|netstat -anp --udp --tcp #PIPE# grep LISTEN
